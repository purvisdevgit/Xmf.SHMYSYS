...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        //public static string connectionString = PubConstant.ConnectionString.Replace("Data Source=", "Data Source=" + AppDomain.CurrentDomain.BaseDirectory);
    ...
    //        try
    //        {
    //            string strPath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "log");
    ...
    //    }
        ...
        {
            //WriteLog(4+connectionString);
            OleDbConnection connection = new OleDbConnection(connectionString);
            OleDbCommand cmd = new OleDbCommand();
            try
            {

                //WriteLog(5 + connection.State.ToString()+ SQLString);
                PrepareCommand(cmd, connection, null, SQLString, cmdParms);
