...
namespace Xmf.SHMYSYS.DAL
{
	...
	public partial class tbUser
	{
		...
		public bool Add(Xmf.SHMYSYS.Model.tbUser model)
		{
			...
			strSql.Append("[GUID],[PASSWORD],[ROLE],[ADDTIME],[ISUSE],[EMAIL])");
		...
		public Xmf.SHMYSYS.Model.tbUser GetModel(string GUID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select [GUID],USERNAME,NICKNAME,AVATAR,PASSWORD,ROLE,ADDTIME,ISUSE,SEX,PHONE,EMAIL,ADDRESS from tbUser ");
			strSql.Append(" where [GUID]=@GUID ");
			OleDbParameter[] parameters = {
					new OleDbParameter("@GUID", OleDbType.VarChar,255)			};
			parameters[0].Value = GUID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select [GUID],USERNAME,NICKNAME,AVATAR,PASSWORD,ROLE,ADDTIME,ISUSE,SEX,PHONE,EMAIL,ADDRESS ");
